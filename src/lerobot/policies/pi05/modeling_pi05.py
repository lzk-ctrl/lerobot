...
class PI05Pytorch(nn.Module):  # see openpi `PI0Pytorch`
    ...
    def _shallow_copy_past_key_values(self, past_key_values):
        ...
        Transformers DynamicCache updates layers in-place when suffix tokens are
        appended. A shallow per-layer copy keeps each denoising step isolated
        without cloning the large prefix tensors.
        """
    ...
    def sample_actions(
        ...
        **kwargs: Unpack[ActionSelectKwargs],
        ...
        # Sample or reshape noise with padded dimension as expected by action_in_proj.
        noise = self._prepare_noise_for_action_samples(noise, bsize, device, num_action_samples)
