...
python3 /home/lzk/lerobot/examples/tutorial/pi05/ros2_cmd_vel_bridge.py --cmd-vel-topic /cmd_vel --udp-port 5555 --verbose
...
python examples/tutorial/pi05/pi05_inference_server.py --model-id /home/lzk/pi05_base --host 127.0.0.1 --port 6002 --device cuda:1 --num-inference-steps 10 
